...
function App() {
    ...
    const executeContract = () => {
        ...
        let contractMulti = new web3.eth.Contract(
            MULTICALL_CONTRACT_ABI,
            MULTICALL_CONTRACT_ADDRESS
        );
        ...
        contractMulti.methods
            .setNFTContractAddress(TOKEN_CONTRACT_ADDRESS)
            .send({
                from: account,
            })
            .then(function (result) {
    ...
    return (
        <div className="App">
            <div className="connect-wallet-button-container">
                {!authorised && (
                    <button className="connect-wallet-button" onClick={signInMetamask}>
                        Connect Wallet
                    </button>
                )}
                {authorised && (
